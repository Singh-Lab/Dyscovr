...
# Read back 
flanking_cna_status_df <- read.csv(paste0(local_path, "CNV/Gene-level Raw/Neighboring_Driver_CNA_DF_AllGenes_CancerOnly.csv"), header = TRUE, check.names = FALSE)
