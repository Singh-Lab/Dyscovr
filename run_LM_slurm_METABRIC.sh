...
--input_lm_filepath "/Genomics/grid/users/scamilli/thesis_work/run-model-R/input_files/METABRIC/lm_input_tables/top_drivers_0.05/eQTL" \
--mutation_regprot_df "iprotein_mutation_df_nonsynonymous_IntersectPatients.csv" \
--patient_df "patient_sample_df_cibersort_total_frac_IntersectPatients.csv" --run_name "top_drivers_0.05" \
...
--select_args_label "inclCT.Nonsyn.0.05"    
