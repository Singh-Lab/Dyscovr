...
# also store the output files here. Argument 2 is a string pattern that the filenames
# of interest should contain.
...
def main():
	...
	for f in filenames:
		if(re.search(pattern, f) != None):
			...
			# Name the output file using the first part of the input file
			name = f.split("_")[0] + "_"
