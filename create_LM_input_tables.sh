...
#--mutation_targ_df "iprotein_mut_count_matrix_silent_IntersectPatientsWashU.csv" --mutation_regprot_df "iprotein_results_silent_IntersectPatientsWashU.csv" \
...
#--target_df "allgene_targets.csv" --cna_bucketing "rawCNA" --meth_bucketing "FALSE" --meth_type "M" --run_name "top_all_0.05_silent" \
...
#Rscript create_lm_input_tables.R --dataset "TCGA" --QTLtype "eQTL" --tumNormMatched "FALSE" --cancerType "BRCA" --removeMetastatic "TRUE" --randomize "FALSE" \
#--test "FALSE" --incl_nextMutDriver "FALSE" --run_query_genes_jointly "TRUE" --protein_ids_df "iprotein_protein_ids_df_gr0.025Freq_drivers_nonsynonymous_lumA.csv" \
...
#--cna_df "CNA_AllGenes_CancerOnly_IntersectPatientsWashU.csv" --patient_df "combined_patient_sample_cibersort_total_frac_tmm_normAge_IntersectPatientsWashU.csv" \
#--target_df "allgene_targets.csv" --cna_bucketing "rawCNA" --meth_bucketing "FALSE" --meth_type "M" --run_name "top_drivers_0.025" \
#--num_PEER 0 --num_pcs 3 --debug "FALSE" --useNumFunctCopies "FALSE" --removeCis "FALSE" \
...
#--test "FALSE" --incl_nextMutDriver "FALSE" --run_query_genes_jointly "TRUE" --protein_ids_df "iprotein_protein_ids_df_gr0.05Freq_drivers_nonsynonymous_tcga.csv" \
...
#--mutation_targ_df "mutation_count_df_nonsynonymous_IntersectPatients.csv" --mutation_regprot_df "iprotein_mutation_df_nonsynonymous_IntersectPatients.csv" \
#--cna_df "cna_df_allgenes_IntersectPatients.csv" --patient_df "patient_sample_df_cibersort_total_frac_IntersectPatients.csv" \
...
--protein_ids_df "iprotein_protein_ids_df_gr0.05Freq_gr2Cts_all_nonsynonymous.csv" \
--expression_df "expression_quantile_norm_IntersectPatientsWashU.csv" \
--methylation_df "methylation_M_CancerOnly_IntersectPatientsWashU.csv" --methylation_df_meQTL "methylation_M_CancerOnly_IntersectPatientsWashU.csv" \
--mutation_targ_df "mut_count_matrix_nonsynonymous_IntersectPatientsWashU.csv" --mutation_regprot_df "iprotein_results_nonsynonymous_IntersectPatientsWashU.csv" \
--cna_df "CNA_AllGenes_CancerOnly_IntersectPatientsWashU.csv" --patient_df "combined_patient_sample_cibersort_total_frac_IntersectPatientsWashU.csv" \
...
#Rscript create_lm_input_tables.R --dataset "TCGA" --QTLtype "eQTL" --tumNormMatched "FALSE" --cancerType "PanCancer" --specificTypes "ALL" \
#--removeMetastatic "TRUE" --randomize "FALSE" --test "FALSE" --incl_nextMutDriver "FALSE" --run_query_genes_jointly "TRUE" \
#--protein_ids_df "iprotein_protein_ids_df_gr0.05Freq_drivers_nonsynonymous_BRCA_BLCA_HNSC.csv" \
...
#--target_df "allgene_targets.csv" --cna_bucketing "rawCNA" --meth_bucketing "FALSE" --meth_type "M" --run_name "top_drivers_0.05_BRCABLCAHNSC" \
#--num_PEER 0 --num_pcs 3 --debug "FALSE" --useNumFunctCopies "FALSE" --removeCis "FALSE" \
...
#--mutation_targ_df "mut_count_matrix_nonsynonymous_COAD_READ_IntersectPatientsWashU.csv" --mutation_regprot_df "iprotein_results_nonsynonymous_COAD_READ_IntersectPatientsWashU.csv" \
#--cna_df "CNA_AllGenes_CancerOnly_COAD_READ_IntersectPatientsWashU.csv" --patient_df "combined_patient_sample_cibersort_total_frac_COAD_READ_IntersectPatientsWashU.csv" \
#--target_df "allgene_targets.csv" --cna_bucketing "rawCNA" --meth_bucketing "FALSE" --meth_type "M" --run_name "top_drivers_0.1_COADREAD_test" \
#--num_PEER 0 --num_pcs 3 --debug "TRUE" --useNumFunctCopies "FALSE" --removeCis "FALSE" \
